...
onclick="closeNav()">&times;</a>
  ...
  <!--#news คือ url-->
  <li><a href="Papaproject.php">Papaproject</a></li>
  <li><a href="Project map.php">Project Map</a></li>
  <li><a href="Datagarbage.php"class="active">Data about bin</a></li>
  <li><a href="afwaste.php">Waste</a></li>

</div>
<h1 align = 'center'>Data about bin</h1>
...
// Check connection
	...
	$query = "SELECT * FROM `databin` WHERE 1 ";
	$result = $dbcon->query($query);
//4 . แสดงข้อมูลที่ query ออกมา โดยใช้ตารางในการจัดข้อมูล: 

echo "<table>";
//หัวข้อตาราง
echo "<tr align='center' bgcolor='turquoise'><td>Zone</td><td>No</td><td>Volume(cm^3)</td><td>Latitude</td><td>Longtitude</td><td>Time</td>";
while($row = $result->fetch_assoc()) 
{ 
  echo "<tr>";
  echo "<td>" .$row["Zone"] .  "</td> "; 
  echo "<td>" .$row["No"] .  "</td> ";  
  echo "<td>" .$row["Volume(cm^3)"] .  "</td> ";
