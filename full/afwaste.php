...
onclick="closeNav()">&times;</a>
  ...
  <li><a href="afwaste.php" class="active">Waste</a></li>

</div>
<h1 align = 'center'>Waste</h1>
...
echo "<table >";
//หัวข้อตาราง 
echo "<tr align='center'  bgcolor='turquoise'><td>Zone</td><td>No</td><td>Waste(kg)</td><td>Percentage</td><td>Time</td>";
